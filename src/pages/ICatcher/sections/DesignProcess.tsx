    ...
    <Box component="section">
      ...
      >
        ...
        <Box component={motion.div} {...fadeSlideFromRight()}>
          ...
          <Typography variant="body2">
            Based on the reserch result I did before, I list down some ideas for the app design. I
            use Miro to create a mindmap board that helps me to think which functions I should add
            and what forms of inspiration I will make in my app design. It makes the navigation of
            my app design more clear.
          </Typography>
          ...
          >
            ...
            <Grid size={4}>
              <Typography variant="body2">
                Post works for sharing to other people and get comments. View other people's works
                to get new ideas. Also follow the people you like and make friends.
              </Typography>
            </Grid>
            <Grid size={4}>
              <Typography variant="body2">
